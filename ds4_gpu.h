 ...
 * span.  Temporary route descriptors and Q8_1 repacks are test-only and are
 * released before return; no persistent weight representation is created. */
int ds4_gpu_rocm_q4k_batch_row_shard_gate_up_tensor(
        ds4_gpu_tensor       *gate,
        ds4_gpu_tensor       *up,
        ds4_gpu_tensor       *mid,
        ds4_gpu_tensor       *xq_scratch,
...
int ds4_gpu_rocm_q4k_batch_row_shard_down_tensor(
        ds4_gpu_tensor       *down,
        ds4_gpu_tensor       *midq_scratch,
